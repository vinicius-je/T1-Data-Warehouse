...
CREATE TABLE `loja` (
  ...
  `nmGerente` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idLoja`)
...
INSERT INTO `loja` VALUES (1,'Farmácia do Bairro','Ana Paula'),(2,'PharmaVital','João Batista'),(3,'Farmácia Saúde & Bem-Estar','Paulo de Tarso');
